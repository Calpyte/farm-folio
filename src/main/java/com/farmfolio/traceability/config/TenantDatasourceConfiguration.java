...
public class TenantDatasourceConfiguration {
    ...
    public DataSource dataSource() throws IOException {
        com.farmfolio.traceability.config.TenantRoutingDatasource tenantDatasource = new com.farmfolio.traceability.config.TenantRoutingDatasource();
        buildDatabaseConnections(tenantDatasource);
        return tenantDatasource;
    }

    private void buildDatabaseConnections(com.farmfolio.traceability.config.TenantRoutingDatasource tenantDatasource) throws IOException {
